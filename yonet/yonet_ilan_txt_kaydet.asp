...
veri.open ("DRIVER={Microsoft Access Driver (*.mdb)};DBQ=" & server.mappath("/isfirsatlari/db/eleman1.mdb"))
...
<p align="center">Bu sitenin amacý siz iþverenlerin, eleman ihtiyacýný, en kýsa yoldan gidermektir.<br><br>
		  ...
		  <br>
		  <br>
		  <a href="yonet_ilan_txt_kayit.asp">buraya týklayarak yeni bir Eleman 
		  Ýlan Formu doldurabilirsiniz </a> 
	  </table>
</div>
</body>
</html>
